...
?>
       <!-- 
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <p class="lead mb-0">
                          Jln. Desa Leweunghapit-Desa Kedungkancana
                            <br />
                            Desa Kedungkancana Kecamatan Ligung Kabupaten Majalengka 45456
                        </p>
                    </div>
                    <!-- Footer Social Icons-->
                    <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <div class="col-lg-4">
                        ...
                        <hr>
                        <p class="lead mb-0">
                           Sistem ini di rancang oleh Muhamad Dendi Purwanto
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Copyright © Sistem Absensi RFID Berbasis WEB, Face Detection dan Notifikasi Telegram</small></div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <div class="container">
                         ...
                         <h3 class="portfolio-modal-title text-secondary text-uppercase mb-0" id="portfolioModal1Label">Login Page</h3>
                                    <!-- Icon Divider-->
                        <div class="divider-custom">
                            <div class="divider-custom-line"></div>
